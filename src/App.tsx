        ...
        <div className="song-content bg-zinc-600 w-[50%] h-[100%] m-0 flex justify-center items-center flex-col">
          <div className="song-copy m-0  h-[60%] w-[100%]">
            <button className="song-copy h-min w-min ml-auto flex">
              <i className="fa-solid fa-circle my-[10px] mx-[10px] text-[30px]"></i>
            </button>
          ...
          <div className="song-range m-0 h-[20%] w-[100%] flex justify-center items-center">
            <button className="h-min w-min flex">
              <i className="fa-solid fa-circle mx-[20px] text-[16px]"></i>
            </button>
          ...
          <div className="song-buttons-actions m-0 h-[20%] w-[100%] flex justify-center items-baseline">
            <button>
              <i className="fa-solid fa-circle  mx-[10px] text-[28px]"></i>
            </button>
            <button>
              <i className="fa-solid fa-circle mx-[10px] text-[28px]"></i>
            </button>
            <button>
              <i className="fa-solid fa-circle mx-[10px] text-[40px]"></i>
            </button>
            <button>
              <i className="fa-solid fa-circle mx-[10px] text-[28px]"></i>
            </button>
